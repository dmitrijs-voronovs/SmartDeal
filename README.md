...
1. Launch ganache
2. `git pull https://github.com/dmitrijs-voronovs/SmartDeal.git && cd SmartDeal && yarn && yarn launch`
...
3. `git pull https://github.com/dmitrijs-voronovs/SmartDeal.git && cd SmartDeal && yarn && yarn launchM`
